  ...
  const schema = {
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        ...
        { "@type": "Offer", itemOffered: { "@type": "Product", name: "L-Shape Sofas" } },
        { "@type": "Offer", itemOffered: { "@type": "Product", name: "Recliner Sofas" } },
        { "@type": "Offer", itemOffered: { "@type": "Product", name: "Leather Sofas" } },
        { "@type": "Offer", itemOffered: { "@type": "Product", name: "Fabric Sofas" } },
        { "@type": "Offer", itemOffered: { "@type": "Product", name: "Corner Sofas" } },
        { "@type": "Offer", itemOffered: { "@type": "Product", name: "Living Room Sets" } },
        { "@type": "Offer", itemOffered: { "@type": "Product", name: "Dining Chairs" } },
        { "@type": "Offer", itemOffered: { "@type": "Product", name: "Curtains & Drapes" } },
