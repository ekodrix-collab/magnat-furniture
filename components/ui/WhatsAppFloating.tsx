            ...
            >
              ...
              <div className="bg-gradient-to-r from-[#111111] to-[#2a2a2a] p-4 relative">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-white font-semibold font-dm-sans">MAGNAT Furniture</h3>
              ...
              <div className="p-5 space-y-4">
                <p className="text-sm text-[#111111]/80 font-dm-sans leading-relaxed">
                ...
                <div className="space-y-2">
                  <a
                    ...
                    className="block w-full bg-[#25D366] hover:bg-[#20bd5a] text-white py-3 px-4 rounded-xl font-dm-sans font-medium text-center transition-all duration-300 hover:shadow-lg"
                  >
                    Start WhatsApp Chat
                  </a>
                  ...
                  <a
                    ...
                    className="block w-full bg-[#111111] hover:bg-[#C0001A] text-white py-3 px-4 rounded-xl font-dm-sans font-medium text-center transition-all duration-300"
                  >
                    Call Now
                  </a>
                </div>
                ...
                <div className="pt-3 border-t border-gray-100">
                  <p className="text-xs text-[#111111]/60 font-dm-sans text-center">
