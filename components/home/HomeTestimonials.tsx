...
function TestimonialCard({ review }: { review: (typeof reviews)[0] }) {
  return (
    ...
    >
      ...
      {/* Review text */}
      <p
        className="text-[#2A2A2A] text-[15px] font-light leading-[1.8] mb-4 flex-grow"
      ...
      <div className="max-container">
        <div className="text-center mb-20 max-w-3xl mx-auto">
          ...
          <motion.h2
            ...
            className="text-[56px] lg:text-[68px] font-light leading-[1.08] tracking-[-0.01em] text-[#1A1A1A]"
            style={{ fontFamily: "var(--font-playfair)" }}
          >
            Trusted by{" "}
            <br />
