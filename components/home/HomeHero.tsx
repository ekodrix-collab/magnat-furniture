  ...
  return (
    <section className="relative h-screen min-h-[850px] w-full overflow-hidden bg-[#111]">
      ...
      <div className="max-container relative z-20 h-full flex flex-col justify-center">
        <div className="max-w-4xl space-y-16 lg:space-y-24">
           ...
           <div className="space-y-8">
              ...
              >
                 <div className="h-px w-12 bg-[#C0001A]" />
                 <span className="text-white font-bold text-[10px] tracking-[0.5em] uppercase">The Art of Living Since 2001</span>
              </motion.div>
           ...
           >
              ...
              <div className="flex flex-col sm:flex-row items-center gap-8">
                 <Link href="/collections" className="btn-primary !bg-white !text-black hover:!bg-[#C0001A] hover:!text-white border-none py-5 px-12 text-[10px] shadow-2xl">
                    Experience Our World
                 </Link>
                 <button className="flex items-center gap-4 group">
                    <div className="w-14 h-14 rounded-full border border-white/20 flex items-center justify-center group-hover:bg-[#C0001A] group-hover:border-[#C0001A] transition-all duration-500">
