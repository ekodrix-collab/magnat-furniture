  ...
  return (
    <main className="pt-20 bg-[#fafaf9] min-h-screen">
      ...
      <section className="hidden md:block bg-[#fafaf9] border-t border-[#f0f0f0] py-20">
        <div className="max-container">
          <h2 className="text-[44px] font-normal leading-[1.1] text-[#111] mb-12" style={{ fontFamily: "var(--font-playfair, serif)" }}>Dining <em className="text-[#C0001A]">Insights</em></h2>
          <div className="grid grid-cols-2 gap-x-16">
            {faqItems.map((item, i) => (
              <details key={item.q} className="group/faq border-b border-[#ebebeb] py-0">
                <summary className="py-6 text-[15px] font-medium text-[#111] cursor-pointer flex items-center justify-between list-none hover:text-[#C0001A]" style={{ fontFamily: "var(--font-inter, sans-serif)" }}>
                   <span>{item.q}</span>
                   <ChevronDown size={16} />
                </summary>
